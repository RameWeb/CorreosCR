(() => {
  ...
  function controladorSucursales($http, $stateParams, $state, servicioSucursales){
    ...
    vm.registrarSucursal = (pnuevaSucursal) => {
      ...
      let objNuevaSucursal = new Sucursales(pnuevaSucursal.provincia.name, pnuevaSucursal.canton.name, pnuevaSucursal.distrito.name,  pnuevaSucursal.direccion, pnuevaSucursal.telefono);
