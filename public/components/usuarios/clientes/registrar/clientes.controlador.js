(() => {
  ...
  controladorClientes.$inject = ['$stateParams', '$state', 'servicioUsuarios', 'imageUploadService', 'Upload'];

  function controladorClientes($stateParams, $state, servicioUsuarios, imageUploadService, Upload) {
    let vm = this;
